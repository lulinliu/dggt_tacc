...
NNODES="${SLURM_NNODES:-${SLURM_JOB_NUM_NODES:-8}}"
...
echo "[torchrun] MASTER_ADDR=${MASTER_ADDR} MASTER_PORT=${MASTER_PORT} NNODES=${NNODES} NODE_RANK=${NODE_RANK} CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES}"
